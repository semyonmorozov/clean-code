...
(upd) Знаки препинания, аналогично пробельным символам, могут идти перед началом или после конца выделения, это может быть __запятая__, _двоеточие_: __точка с запятой__; (_обычная скобка_) {__фигурная скобка__} "_кавычки_" __восклицание__! _знак вопроса_? __точка__.
